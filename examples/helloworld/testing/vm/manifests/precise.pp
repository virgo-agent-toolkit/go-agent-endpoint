...
exec { "O_O":
  command => "/bin/mkdir -p /data/O_O && /bin/mount --bind /data/gopath/src/github.com/racker/go-agent-endpoint/examples/helloworld/testing/vm/O_O /data/O_O",
...
file { '/home/vagrant/.profile':
  ...
  content => template('/data/gopath/src/github.com/racker/go-agent-endpoint/examples/helloworld/testing/vm/manifests/templates/profile.erb'),
}
